...
<p>
	您好，<strong><?php echo $this->vars['admin_user'];?></strong> [ <?php echo $this->vars['admin_level'];?> ] [ <a href="../" target="_blank">去首页</a> ] [<a href="admin_login?action=logout" target="_parent"> 退出</a> ]
</p>
</body>
</html>