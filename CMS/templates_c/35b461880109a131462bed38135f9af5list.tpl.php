...
<div id="list">
	<h2>当前位置 &gt; <?php if ($this->vars['par_name']) {?><a href="list.php?id=<?php echo $this->vars['par_id'];?>"><?php echo $this->vars['par_name'];?></a> &gt;<?php } ?> <a href="list.php?id=<?php echo $this->vars['nav_id'];?>" target="_blank"><?php echo $this->vars['nav_name'];?></a></h2>
	<?php if ($this->vars['AllContent']) {?>
	<?php foreach($this->vars['AllContent'] as $key=>$value) { ?>
	<dl>
